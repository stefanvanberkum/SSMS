...
class SSMS_alt_2(sm.tsa.statespace.MLEModel):
    def __init__(self, data: pd.DataFrame, group_name: str, y_name: str, z_names: list, d_names: list, c_names: list,
                 cov_rest: str, cov_group='', var_start=0.1, cov_start=0, fancy_start=True):
        """
        Constructs a state space model for sales, with region-invariant variable of interest in the sales and beta (
        coefficients of independent variables) equations.
        ...
        # Intialize the state-space model.
        super(SSMS_alt_2, self).__init__(endog=y, exog=x_dc, k_states=2 * n + k, initialization='approximate_diffuse')
    ...
    def start_params(self):
        ...
        # Number of lambda: k_d + k * k_c
        lambda_start = np.zeros(k_d + k * k_c)
    ...
    def update(self, params, **kwargs):
        ...
        :return:
        """
        params = super(SSMS_alt_2, self).update(params, **kwargs)
...
class SSMS_alt_3(sm.tsa.statespace.MLEModel):
    def __init__(self, data: pd.DataFrame, group_name: str, y_name: str, z_names: list, c_names: list, cov_rest: str,
                 cov_group='', var_start=0.1, cov_start=0, fancy_start=True):
        """
        Constructs a state space model for sales, with region-invariant variable of interest in the beta (
        coefficients of independent variables) equations.
        ...
        # Intialize the state-space model.
        super(SSMS_alt_3, self).__init__(endog=y, exog=x_c, k_states=2 * n + k, initialization='approximate_diffuse')
    ...
    def start_params(self):
        ...
        # Number of lambda: k * k_c
        lambda_start = np.zeros(k * k_c)
    ...
    def update(self, params, **kwargs):
        ...
        :return:
        """
        params = super(SSMS_alt_3, self).update(params, **kwargs)
...
class SSMS_alt_4(sm.tsa.statespace.MLEModel):
    def __init__(self, data: pd.DataFrame, group_name: str, y_name: str, z_names: list, cov_rest: str, cov_group='',
                 var_start=0.1, cov_start=0, fancy_start=True):
        """
        Constructs a state space model for sales, with region-invariant variable of interest modeled in a
        state-equation.
        ...
        # Construct arrays of group names, and endogenous (y) and exogenous (x) variables.
        group_names, y, x_z, x_c, cov_groups, cov_counts = construct_arrays(data, group_name, y_name, z_names, [],
                                                                            cov_group)
    ...
    def update(self, params, **kwargs):
        ...
        :return:
        """
        params = super(SSMS_alt_4, self).update(params, **kwargs)
